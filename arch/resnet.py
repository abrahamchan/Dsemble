...
def get_resnet_by_n(n, input_shape, classes=10):
    # Model parameter
    # ----------------------------------------------------------------------------
    ...
    if version == 2:
        model = resnet_v2(input_shape=input_shape, depth=depth, num_classes=classes)
    else:
        model = resnet_v1(input_shape=input_shape, depth=depth, num_classes=classes)
    return model
